...
namespace EKomplet.Data
{
    public class DbInitializer
    {
        public static void Initialize(DistrictDBContext context)
        {
            ...
            {
                new Salesman{PhoneNumber = 29223018, Email ="3ilyes.hamliliy@boarebec.gq", FirstName="Maria", LastName=" Hansen"},
                new Salesman{PhoneNumber = 59537894, Email ="yihsan.niazi@perresu.gq", FirstName="Marie", LastName=" Didricksen"},
                new Salesman{PhoneNumber = 44861150, Email ="cabdoelrah@toughblarbarw.ml", FirstName="Esther ", LastName="Pedersen"},
                new Salesman{PhoneNumber = 11047129, Email ="7osman.gebr@walmarte-shop.com", FirstName="Sara", LastName=" Hansen"},
                new Salesman{PhoneNumber = 93962566, Email ="you-m97p@mylittleali.ml", FirstName="Elise", LastName="Gregersen"},
                new Salesman{PhoneNumber = 11224489, Email ="tbabich.messiz@elmenormi.tk", FirstName="Mark", LastName="Pedersen"},
                new Salesman{PhoneNumber = 68979197, Email ="mchriscoobbers@presaper.cf", FirstName="Leo", LastName=" Hansen"},
                new Salesman{PhoneNumber = 36486664, Email ="ealkass@doctxyle.ml", FirstName="Peter", LastName="Teglsgaard"},
                new Salesman{PhoneNumber = 73140749, Email ="ichouki-starf@lokingmi.cf", FirstName="Tobias", LastName=" Hansen"},
                new Salesman{PhoneNumber = 37887231, Email ="hayoub.fa@citywinetour.com", FirstName="Jonathan", LastName="Gregersen"},

            };
            foreach(Salesman s in salesmen)
            {
                context.Salesmen.Add(s);
            }
            context.SaveChanges();
            ...
            foreach (SalesmenInBusiness b in salesmenInBusiness)
            {
                context.SalesmenInBusinesses.Add(b);
            }
            context.SaveChanges();
            ...
            foreach(SalesmenStatus s in salesmenStatus)
            {
                context.SalesmenStatuses.Add(s);
            }
            context.SaveChanges();
